<template>
  <tbody>
    <tr ref="dev">
      ...
      <td style="width: 50px;" id="d-2020-01-01"></td>
      <td style="width: 50px;" id="d-2020-02-01"></td>
      <td style="width: 50px;" id="d-2020-03-01"></td>
      <td style="width: 50px;" id="d-2020-04-01"></td>
      <td style="width: 50px;" id="d-2020-05-01"></td>
      <td style="width: 50px;" id="d-2020-06-01"></td>
      <td style="width: 50px;" id="d-2020-07-01"></td>
      <td style="width: 50px;" id="d-2020-08-01"></td>
      <td style="width: 50px;" id="d-2020-09-01"></td>
      <td style="width: 50px;" id="d-2020-10-01"></td>
      <td style="width: 50px;" id="d-2020-11-01"></td>
      <td style="width: 50px;" id="d-2020-12-01"></td>
    </tr>
