...
<div class="relative bg-white overflow-hidden">
      ...
      <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
          ...
          <div class="hidden md:block md:ml-10 md:pr-4">
            ...
            <router-link tag="a" to="/about" class="ml-8 font-medium text-indigo-600 hover:text-indigo-900 transition duration-150 ease-in-out">Projects</router-link>
          </div>
        </nav>
      </div>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="@/assets/photo.jpeg" alt="">
  </div>
</div>
</template>
